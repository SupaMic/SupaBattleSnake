defmodule SupaBattleSnake.LegalMoves do
  ...
  def update_legal_moves(game_data, move, head, check_coords) do
    not_legal = GamePieces.check_coord_occupied?( GamePieces.future_coords(head, move), check_coords ) 
    case not_legal do
  ...
  def update_legal_moves(game_data, move, head, check_coords, :downgrade) do
    discouraged = GamePieces.check_coord_occupied?( GamePieces.future_coords(head, move), check_coords ) 
